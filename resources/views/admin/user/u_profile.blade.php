...
<head>
    ...
    <link rel="stylesheet" href="{{asset(url('admin_css/u_profile.css'))}}">
            ...
            <div class="container-fluid user_table_content">
                <div class="row">
                    <div class="col-12 p-0 pt-3 pb-3">
                        <h4 class="text-white text-center text-uppercase" style="letter-spacing: 3px;">User Profile Picture
                        </h4>

                        <div class="user_profile">
                            <img src='{{asset(url("profile_image/$user_info->image"))}}' alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mt-5 last_login">
                        ...
                        <table class="table text-white text-center">
                            ...
                            <thead>
                                <tr>
                                    <th>Last Participate</th>
                                    <th>Start Date</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td>@if(!empty($tournament)) {{$tournament->tournament_name}} @else Not PArticipate Yet. @endif</td>
                                    <td>@if(!empty($tournament)) {{$tournament->start_date}} @else Not PArticipate Yet. @endif</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="table text-white text-center">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    @php
                                    $datetime1 = strtok($user_info->login_stamp, " ");
                                    $date = new DateTime($datetime1);
                                    $now = new DateTime();

                                    $day_diff = $date->diff($now)->format("%d");
                                    if($day_diff <= 2) { echo"<td><button class='btn btn-success'>Active</button></td>";
                                        } else {
                        ...
                        <table class="table text-white text-center">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>Runner up</th>
                                    <th>Win %</th>
                                    <th>Winning Prize [Cash + Other in cash]</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
